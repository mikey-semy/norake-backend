...
from src.core.exceptions import (InvalidUserDataError, TokenExpiredError,
...
class TokenManager:
    ...
    @staticmethod
    def create_refresh_payload(user_id: Union[int, str, uuid.UUID]) -> dict:
        """
    ...
    @staticmethod
    def create_refresh_token(user_id: Union[int, str, uuid.UUID]) -> str:
        """
