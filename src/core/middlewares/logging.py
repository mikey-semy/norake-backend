...
Компоненты:
    - LoggingMiddleware: класс middleware для перехвата и логирования запросов
    - Обработка исключений с преобразованием в JSON-ответы
...
Зависимости:
    ...
    - src.core.config для конфигурации
    - src.core.exceptions для обработки ошибок
"""
